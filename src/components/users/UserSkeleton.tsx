...
/** Pulsing placeholder shaped like a UserCard, shown while the list is "loading". */
      ...
      <View className="flex-row items-start justify-between">
        <View className="flex-row items-start gap-3">
          ...
          <View className="gap-2">
            ...
            <View className="h-3 w-40 rounded bg-slate-200 dark:bg-slate-700" />
          </View>
        </View>
        <View className="h-5 w-14 rounded-full bg-slate-200 dark:bg-slate-700" />
      </View>

      <View className="mt-3 h-3 w-28 rounded bg-slate-200 dark:bg-slate-700" />
