...
/** Rounded pill search input used at the top of the Bills list. */
export const BillSearch = forwardRef<RNTextInput, BillSearchProps>(function BillSearch(
  { value, onChangeText, placeholder = 'Search by bill number...' },
  ref,
) {
  return (
