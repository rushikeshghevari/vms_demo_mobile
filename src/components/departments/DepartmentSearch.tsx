...
/** Rounded pill search input used at the top of the Departments list. */
export const DepartmentSearch = forwardRef<RNTextInput, DepartmentSearchProps>(
  ({ value, onChangeText, placeholder = 'Search departments...' }, ref) => {
    return (
