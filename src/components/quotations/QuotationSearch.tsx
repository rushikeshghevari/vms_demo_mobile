...
/** Rounded pill search input used at the top of the Quotations list. */
export const QuotationSearch = forwardRef<RNTextInput, QuotationSearchProps>(function QuotationSearch(
  { value, onChangeText, placeholder = 'Search by quotation number...' },
  ref,
) {
  return (
    <View className="flex-row items-center gap-2 rounded-2xl border border-slate-200 bg-white px-4 py-3 dark:border-slate-700 dark:bg-slate-900">
      ...
      <TextInput
        ...
        accessibilityLabel="Search quotations"
        autoCapitalize="none"
        autoCorrect={false}
