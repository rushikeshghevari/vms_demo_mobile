...
/** Rounded pill search input used at the top of the Vendors list. */
export const VendorSearch = forwardRef<RNTextInput, VendorSearchProps>(function VendorSearch(
  { value, onChangeText, placeholder = 'Search by name, code, GST, mobile...' },
  ref,
) {
  return (
